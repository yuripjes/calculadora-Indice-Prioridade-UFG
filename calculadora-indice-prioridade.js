    ...
    methods: {
        ...
        contabilizaCargaHorariaCursada(somaCHC) {
            if (this.qtdPeriodos === 1) {
                return somaCHC < 256 ? 256 : somaCHC;
            } else if (this.qtdPeriodos === 2) {
                return somaCHC < 512 ? 512 : somaCHC;
            }
        },
...
apagar abaixo
    ...
    <template v-if="etapa===1">
      ...
      <br /><br />
      <button v-on:click="preencherDoisPeriodosDeTeste()"><i class="fa fa-exclamation" /> Preencher dois períodos de teste</button>
      <br /><br />
...
<form @submit.prevent="calcular">
      ...
      <input id="matricula" type="number" v-model="inputMatricula"></input>
      <br />
      ...
      <div style="border:1; border" v-for="(itemPeriodo, index) of periodos">
        ...
        <table>
          ...
          <tbody>
            <tr v-for="(item, index) of itemPeriodo.disciplinas">
              <td>
                <input type="text" v-model="item.disciplina"></input>
              </td>
              <td>
